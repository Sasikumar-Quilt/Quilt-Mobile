...
import 'feed/FeedWebView.dart';
import 'feed/HomeWidgetRoute.dart';
import 'feed/QuickerScrollPhysics.dart';
import 'feedback/FeedbackWidget.dart';
import 'journal/JournalListWidget.dart';

class DashboardWidgetBackUp extends BasePage {
  DashboardWidgetBackUp({Key? key}) : super(key: key);

  @override
  DashboardWidgetState createState() => DashboardWidgetState();
}

class DashboardWidgetState extends BasePageState<DashboardWidgetBackUp>
...
//audio player
  ...
  void playAudio() async {
    print("gameAudio");
    if (contentList == null || contentList!.isEmpty|| contentList![pageCount]!.contentFormat != "WEB_VIEW"||Utility.isEmpty( contentList![pageCount]!.audioURL)) {
      return;
    }
    print(contentList![pageCount].duration);
    print(contentList![pageCount].audioURL);
    audioManager.setCurrentAction("Feed");
    await audioManager.playAudio(contentList![pageCount]!.audioURL!,contentList![pageCount]!.duration,true);
    audioManager.setVolume(isMute);

   /* if (contentList![pageCount]!.duration != null) {
      await player.play(UrlSource(contentList![pageCount]!.audioURL!),
          position: contentList![pageCount]!.duration);
    } else {
      await player.play(UrlSource(contentList![pageCount]!.audioURL!));
    }*/
   ...
   /* player.onPositionChanged.listen((event) {
      //print(event);
      contentList![pageCount].duration = event;
     // print("event");
      //print(contentList![pageCount].duration);
    });*/
  }
  ...
  @override
  void didUpdateWidget(covariant DashboardWidgetBackUp oldWidget) {
    ...
    if (currentRouteName == HomeWidgetRoutes.DashboardWidget ||
     ...
     // resumeFunction();
      ...
      if(timer!=null||currentRouteName==HomeWidgetRoutes.FavoriteWidget){
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) async {
    if (currentRouteName == HomeWidgetRoutes.DashboardWidget ||
      ...
      if (state == AppLifecycleState.paused) {
        ...
        timer = null;
        print(isNeedPrompt);
        if (isNeedPrompt && (currentRouteName == HomeWidgetRoutes.DashboardWidget ||
            currentRouteName == "/")||(currentRouteName==null)) {
          isNeedPrompt=false;
          ...
          isNeedPrompt = false;
          if ((currentRouteName == HomeWidgetRoutes.DashboardWidget ||
              currentRouteName == "/"||currentRouteName==null)&&contentList!=null&&contentList!.isNotEmpty) {
            if(bIsPlay){
              isPlay=true;
              playAudio();
            }
            ...
            Align(
                child: contentList != null && contentList!.length > 0
                  ...
                  child: PageView.builder(
                    controller: _pageController,physics: !isScroll?NeverScrollableScrollPhysics():null,
                    ...
                    onPageChanged: (index) async{
                     await pauseAudio();
                      ...
                      if (contentList![index]!.contentFormat == "WEB_VIEW") {
                        playAudio();
                      }
                      isScroll=true;
                      bool isSwiped =
                              ...
                              children: [
                                contentList![index].contentType ==
                                  ...
                                  child:  FastCachedImage(
                                    url: contentList![index].animations!,
                                    fit: BoxFit.cover,
                                    ...
                                    contentList![index]
                                        .contentFormat ==
                                        "VIDEO"
                                    ? VideoWidget(updateVideoController:null,key: Key('feed-item-$index'),isVisible: index == pageCount,id: contentList![index].contentId!,
                                  audioUrl: contentList![index]
                                      .isVideoAudio
                                      ? contentList![index]
                                      .audioURL
                                      : "",
                                  ...
                                  isVideoAudio:
                                  contentList![index]
                                      .isVideoAudio,videoPlayerController: preloadVideos.controllers.isNotEmpty?preloadVideos.controllers[index]??null:null,
                                )
                                    : Align(
                                  alignment: Alignment.center,
                                  child: contentList![index]
                                      .animations !=
                                      null&&contentList![index]
                                      .animations!.length>10
                                      ? Container(
                                    child:LottieWidget(animationJsonString: contentList![
                                    index]
                                        .animations!) ,
                                    margin:
                                    EdgeInsets.only(
                                      ...
                                      children: [
                                        Container(
                                          child: Column(
                                            ...
                                            children: [
                                              contentList![
                                              index].contentType!="ASSESSMENT"? GestureDetector(
                                                child: Container(
                                              ...
                                              contentList![
                                              index].contentType!="ASSESSMENT"?InkWell(
                                                child: Container(
                                                  child: !contentList![
                                                  index]
                                                      .isFav
                                              ...
                                              /* Container(
                                                ...
                                                margin: EdgeInsets.only(
                                                    right: 4,
                                                    bottom: ((contentList![index].contentType == "GAME") ||
                                                        (contentList![
                                                        index]
                                                            .contentType ==
                                                            "JOURNAL") ||
                                          ...
                                          child: Row(
                                            children: [
                                                    ...
                                                    children: [
                                                      Container(
                                                        child:/* TextScroll(
                                                          ...
                                                          style: TextStyle(
                                                              ...
                                                              fontFamily:
                                                              "Causten-Medium"),
                                                        )*/TextScrollWidget(text: contentList![index]
                                                            .contentType ==
                                                            "ASSESSMENT"
                                                            ? contentList![
                                                        index]
                                                            ...
                                                            : contentList![
                                                        index]
                                                            .contentName!, scrollSpeed:  pageCount ==
                                                            index
                                                            ? 50
                                                            : 0, shouldScroll: true,),
                                                      ),
                                                      contentList![index]
                                                        ...
                                                        child: Row(
                                                          ...
                                                          : Container(),
                                                      contentList![index].contentType=="ASSESSMENT"?Container(child: Column(children: [
                                                        Container(  margin: EdgeInsets.only(bottom: 10,top: 10),child: Row(children: [
                                                          Container(child: SvgPicture.asset("assets/images/user_ass.svg"),),
                                                        ...
                                                        Container(  margin: EdgeInsets.only(bottom: 10),child: Row(children: [
                                                          Container(child: SvgPicture.asset("assets/images/target_ass.svg"),),
                                                          Container(margin:EdgeInsets.only(left: 10),
                                                            child: Text(
                                              ...
                                              !((contentList![index]
                                                  ...
                                                  (contentList![index]
                                                      .contentType ==
                                                      "EMI")|| (contentList![index]
                                                  .contentType ==
                                                  "INFO_TIDBITS")||(contentList![index]
                                                  .contentType ==
                                                  "INFO_TIDBITS_OCD")||(contentList![index]
                                                  .contentType ==
                            ...
                            onTap: () {
                              ...
                              if (contentList![index].contentFormat ==
                                ...
                                Navigator.pushNamed(context,
                                    HomeWidgetRoutes.VideoplayerWidget,
                                    arguments: {
                                      "url": contentList![index],"index":index
                                    }).then((value) => {
                                ...
                                Navigator.pushNamed(context,
                                    HomeWidgetRoutes.JournalWidget,
                                    arguments: {
                                      "url": contentList![index],"index":index
                                    }).then((value) =>
                              ...
                              index]
                                ...
                                print(contentList![index].contentUrl!);
                                Navigator.pushNamed(
                                    context, HomeWidgetRoutes.EmiWidget,
                                    arguments: {
                                      "url": contentList![index],"index":index
                                    }).then((value) =>
                                {isPlay = true, _phoneStateSubscription?.resume(), setState(() {})});
                                ...
                                setState(() {});
                                Navigator.pushNamed(context,
                                    HomeWidgetRoutes.AudioPlayerWidget,
                                    arguments: {
                                      "url": contentList![index],"index":index
                                    }).then((value) => {
                                  _phoneStateSubscription?.resume(),
                                  updateAudioLastPosition(
                                      value, index)
                                });
                              } else {
                                pauseAudio();
                                Navigator.pushNamed(context,
                                    HomeWidgetRoutes.webScreenScreen,
                                    arguments: {
                                      "url": contentList![index]
                                    }).then((value) => playAudio());
                              }
                            },
                          ),
                          isShowSwipeAnim
                    ...
                    : isContentListApiRunning?Container(child: Lottie.asset("assets/images/feed_preloader.json"),):Container()),
            Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          InkWell(child: Container(
                            child: isHasTag?Icon(Icons.arrow_back_ios_new_outlined,size: 18,color: Colors.white,):SvgPicture.asset(
                            ...
                            if(isHasTag){
                              ...
                              if (contentList![pageCount].contentFormat == "WEB_VIEW") {
                                playAudio();
                              }
...
void refreshFeed(){
  ...
  Future<void> getCollectionList() async {
    ...
    if (sCollectionList.collectionList!.isNotEmpty) {
      ...
      /*  if(collectionList.length>1){
        moveObjectToFirst(collectionList);
      }*/
      ...
      /*if(collectionList.where((element) => element.collectionName=="Your Library").toList().isEmpty){
  ...
  void showSnackbar(String collectionName, bool isFav) {
    ...
    final snackBar = SnackBar(
      ...
      elevation: 0,
      margin: EdgeInsets.only(
          bottom: MediaQuery.of(context).size.height - height, right: 5, left: 5),
      ...
      if (cList.contentList != null && cList.contentList!.isNotEmpty) {
        ...
        if (contentList!.length <= 10 && _pageController!.hasClients) {
         ...
         pageCount=0;
          ...
          if (contentList![0].contentFormat == "WEB_VIEW"&&isClosedBottomSheet) {
            print("audio2");
            playAudio();
          }
        ...
        setState(() {});
     /*   List<String> contentEncoded = contentList!
            .map((content) => jsonEncode(content.toJson()))
            .toList();
        saveContentList(contentEncoded);*/
      } else {
        hasMoreData = false;
        print(contentList);
      ...
      //Utility.showToast(apiResponse.message.toString());
    }
  ...
  void saveContentList(List<String> list) {
    //PreferenceUtils.setStringList("contentList", list);
  }
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(builder: (BuildContext context, setState) {
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      shape: BoxShape.circle,
                                      color: isFullEmotion?Color(0xff40A1FB):Color(0xff6D6D6D),
                                    ),
                                  ),
                                  margin:
          ...
          if (contentList != null && contentList!.isNotEmpty)
            {
              if (pageCount<contentList!.length&&contentList![pageCount].contentFormat == "WEB_VIEW")
  ...
  void showFeedbackDialog(ContentObj contentObj) {
   ...
   /* showDialog(
      ...
      builder: (BuildContext context) {
        return Dialog(
          backgroundColor: Colors.transparent, // Makes the background of the dialog transparent
          insetPadding: EdgeInsets.all(0), // Removes padding around the dialog
  ...
  void updateVideoPosition(int index, Duration position) {
    if (contentList != null&&contentList!.isNotEmpty && contentList!.length >= index) {
      contentList![index].duration = position;
     // print("updateVideoPosition$index");
     // print(contentList![index].duration);
    }
    if (mounted) {
      // setState(() {});
