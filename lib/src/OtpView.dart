...
typedef OnCodeEnteredCompletion = void Function(String value,String code);
typedef OnCodeChanged = void Function(String value,String code);
...
class _OtpTextFieldState extends State<OtpView> {
  ...
  @override
  void didUpdateWidget(covariant OtpView oldWidget) {
  ...
  Widget _buildTextField({
    ...
    return Container(
      ...
      margin: widget.margin,decoration: BoxDecoration(color: Color(0xFF272727),borderRadius: BorderRadius.circular(10)),
      child: TextFormField(
        ...
        decoration: widget.hasCustomInputDecoration
            ? !Utility.isEmpty(_verificationCode[index])? InputDecoration(
          enabledBorder: OutlineInputBorder(
            borderSide:const BorderSide(color: Color(0xff131314), width: 0.6), // No border
        ...
        onChanged: (String value) {
          ...
          onCodeChanged(verificationCode: value,code:getCode(_verificationCode));
  ...
  getCode(List<String?> _verificationCode){
   if (_verificationCode.every((String? code) => code != null && code != '')) {
  ...
  void onCodeChanged({required String verificationCode, required String code}) {
    if (widget.onCodeChanged != null) {
      widget.onCodeChanged!(verificationCode,code);
    }
  }
}
