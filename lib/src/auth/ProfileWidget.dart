  ...
  Future<void> logoutApi() async {
    ...
    if (apiResponse.responseCode == 200) {
      ...
      Navigator.pushNamedAndRemoveUntil(
          context, HomeWidgetRoutes.SplashScreen, (route) => false);
    } else {
      isLogout = false;
      Utility.showSnackBar(context: context, message: "Failed to logout");
      isApiContentLoading = false;
      setState(() {});
    }
  }
                          ...
                          InkWell(
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                  ...
                                  arguments: {
                                    "editType": 4
                                  }).then((value) => {deletingImage(value)});
                            },
                          ),
                          Divider(
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              SvgPicture.asset(
                                  "assets/images/info_profile.svg"),
                              Expanded(
                                  child: Container(
                                margin: EdgeInsets.only(left: 10, top: 0),
                                child: Text(
...
*/
  ...
  Future<void> notificationUpdateApi(String notification) async {
    /*  isApiContentLoading = true;
    setState(() {});*/
    try {
      ...
      request.fields['notification'] = notification;
