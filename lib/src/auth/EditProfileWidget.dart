                ...
                editType == 3
                    ? InkWell(
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              SvgPicture.asset(genderType == 1
                                  ? "assets/images/lead_icon.svg"
                                  : genderType == 2
                                      ? "assets/images/female_icon.svg"
                                      : genderType == 3
                                          ? "assets/images/non_binary_icon.svg"
                                          : "assets/images/other_icon.svg"),
                              Expanded(
                                  child: Container(
...
//notification
                editType == 5
                    ...
                    : Container(),
                editType == 5 && isNotificationOpened
                    ? Container(
                        margin: EdgeInsets.only(left: 15, top: 20, right: 15),
                        decoration: BoxDecoration(
                            color: Color(0xff3D3D3D).withOpacity(0.45),
                              ...
                              file != null
                                  ? CircleAvatar(
                                      ...
                                      backgroundImage: file != null
                                          ...
                                          : AssetImage(
                                              'assets/images/default_photo_edt.png'),
                              ...
                              Align(
                                child: Container(
                                  ...
                                  child: SvgPicture.asset(
                                      "assets/images/pencil_simple.svg"),
                                  alignment: Alignment.center,
  ...
  void openImage(int type) async {
    ...
    final targetPath =
        path.join(directory.path, 'compressed_${path.basename(image!.path)}');
    ...
    try {
      ...
      if (!isDelete) {
        if (editType == 1) {
          ...
          request.fields['notification'] = profileObject!.notification;
        }
      } else {
