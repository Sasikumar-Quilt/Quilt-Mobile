              ...
              if (collectionObject.collectionObject != null)
                {
                  ...
                  PreferenceUtils.setString("collectionID",
                      collectionObject.collectionObject!.collectionId!),
                  collectionList.add(collectionObject.collectionObject!),
                  updateFavorite(widget.id,
                      collectionObject.collectionObject!.collectionId!, true),
                }
              else
                {isApiCalling = false, setState(() {})}
            });
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextField(
                            ...
                            style: TextStyle(
                                fontFamily: "Causten-Medium", fontSize: 14),
                            onChanged: (text) {
                              if (text.isNotEmpty) {
                                isEnable = true;
                              } else {
                  ...
                  : Column(
                      ...
                      children: <Widget>[
                            ...
                            itemBuilder: (BuildContext context, int position) {
                              return Container(
                                ...
                                child: Row(
                                  children: [
                                    SvgPicture.asset(
                                        "assets/images/your_library.svg"),
                                    Expanded(
                                        child: Container(
                                      child: Column(
                                        crossAxisAlignment:
                        ...
                        Container(
                          child: ListTile(
                            leading:
                                SvgPicture.asset("assets/images/new_add.svg"),
