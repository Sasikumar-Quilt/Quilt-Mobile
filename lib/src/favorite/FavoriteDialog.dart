    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Stack(children: [
          isNewCollection?Column( mainAxisSize: MainAxisSize.min,children: [
            Container(
              width: 40,
              height: 5,
              decoration: BoxDecoration(
            ...
            children: <Widget>[
              ...
              Container(child: ListView.builder(itemBuilder: (BuildContext context,int position){
                return Container(margin: EdgeInsets.only(left: 15,right: 15,top: 10,bottom: 10),child: Row(children: [
                  ...
                  InkWell(child: Icon(PreferenceUtils.getString("collectionID", "")==collectionList[position].collectionId?Icons.bookmark:Icons.bookmark_border,color: PreferenceUtils.getString("collectionID", "")==collectionList[position].collectionId?Colors.black:Color(0xff888888)),onTap: () async {
                    if(widget.isFav){
                      isApiCalling=true;
                      setState(() {
                      ...
                      await apiHelper.updateFavorite(widget.id,PreferenceUtils.getString("collectionID", ""),false).then((value) =>
                      {
