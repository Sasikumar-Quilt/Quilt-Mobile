...
class TextScroll extends StatefulWidget {
  const TextScroll(
      this.text, {
        ...
        this.fadeBorderVisibility = FadeBorderVisibility.auto,this.scrollStart
      }) : super(key: key);
...
print(widget.scrollStart!);
print("scrollStart");
    if (binding != null&& widget.scrollStart!) {
